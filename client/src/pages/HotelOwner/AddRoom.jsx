        ...
        <div>
            <form onSubmit={onSubmitHandler} className="">
                ...
                in the details carefully and accurate room details, pricing and
                 amenities, to enhance user booking experience" />
                ...
                <div className="grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap">
                    {Object.keys(images).map((key) => (
                        <label htmlFor={`roomImages${key}`} key={key}
                            ...
                            <input type="file" accept='image/*' id={`roomImages${key}`} hidden onChange={
                ...
                <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
                    <div className="flex-1 max-w-48">
                        ...
                        <select value={inputs.roomType} onChange=
                            {e => { setinputs({ ...inputs, roomType: e.target.value }) }}
                            name="" id="" className='border opacity-70
