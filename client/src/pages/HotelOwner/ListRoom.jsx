...
const ListRoom = () => {
    ...
    const fetchRooms = async () => {
        try {
            ...
            console.log("Response data:", data); // <-- Debug here
            if (data.success) {
    ...
    const toggleAvaliability = async (roomId) => {
                ...
                <table className="w-full">
                    ...
                    <tbody className="text-sm">
                        {Array.isArray(rooms) && rooms.length > 0 ? (
                                ...
                                <tr key={index}>
                                    ...
                                    <td className='py-3 px-4 border-t border-gray-300 text-red-500 text-center'>
                                        <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
                                            <input onChange={() => toggleAvaliability(item._id)} type="checkbox" className="sr-only peer" checked={item.isAvailable} />
                            ...
                            <tr>
                                <td colSpan="4" className="text-center py-4 text-gray-500">No rooms found</td>
                            </tr>
                        )}
                    </tbody>
